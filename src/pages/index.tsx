  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience YATTO - Your open source API Security platform. Uncover all APIs in real time, test for vulnerabilities, and ensure seamless integration with your preferred CI/CD tools for a comprehensive security solution."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1685625744937-a157faa7fb64?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxBUEklMjBzZWN1cml0eXxlbnwwfHx8fDE2OTQ1MTAyODF8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@bantaru_?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Bantar Prakoso`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience YATTO - Your open source API Security platform. Uncover all APIs in real time, test for vulnerabilities, and ensure seamless integration with your preferred CI/CD tools for a comprehensive security solution.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="App Sec" type="app-sec" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>

...
import { getTestResultById } from 'apiSdk/test-results';
import { TestResultInterface } from 'interfaces/test-result';

function TestResultViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('test_result', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/test-results/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Vulnerability" text={data?.vulnerability} />
